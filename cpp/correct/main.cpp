...
int main()
{
    ...
    cout << "The ASCII code of 't' is " << int('t') << " which in binary is " << binary << endl
         << endl;

    char ch;
    ch = binary_to_ascii("01000001");
    cout << "The character correspoding to the binary number 01000001 is '" << ch << "'" << endl
         << endl;
    ...
    cout << "'Art' encoded as binary is " << encoded << endl
         << endl;

    binary_to_text("010000010111001001110100", text);
    cout << "010000010111001001110100 decoded as text is '" << text << "'" << endl
         << endl;
    ...
    cout << "010000010111001001110100 with error correction bits inserted is: " << endl
         << correct << endl
         << endl;
    ...
    cout << "which as text is '" << text << "'" << endl
         << endl;
